...
async function loadData() {
  ...
  const fireIcon = L.icon({
    iconUrl: "/boukamap/static/images/fire.png", // ← ここをカスタム画像のURLに変更
    iconSize: [32, 32], // アイコンのサイズ
    iconAnchor: [16, 32], // アンカーの位置
    popupAnchor: [0, -32] // ポップアップの位置調整
  });
  const waterTankIcon = L.icon({
    iconUrl: "/boukamap/static/images/water.png", // ← ここをカスタム画像のURLに変更
    iconSize: [32, 32], // アイコンのサイズ
    iconAnchor: [16, 32], // アンカーの位置
    popupAnchor: [0, -32] // ポップアップの位置調整
  });
  const hydrantIcon = L.icon({
    iconUrl: "/boukamap/static/images/hydrant.png", // ← ここをカスタム画像のURLに変更
    iconSize: [32, 32], // アイコンのサイズ
    iconAnchor: [16, 32], // アンカーの位置
    popupAnchor: [0, -32] // ポップアップの位置調整
  });
